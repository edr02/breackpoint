        ...
        <div className="flex-col">
          <div className="overlap-group-1">
            <div className="flex-row-1">
              <img className="rsp-logo-1-1" src={rspLogo1} />
              <TextInput />
            </div>
            <img className="line-1-1" src={line1} />
          </div>
          <div className="sfondo_schermata_passerelle-container-1">
            <img className="sfondo_schermata_passerelle-1-1 animate-enter2" src={sfondo_Schermata_Passerelle1} />
            <img className="sfondo_schermata_passerelle-2-1 animate-enter3" src={sfondo_Schermata_Passerelle2} />
            <img className="sfondo_schermata_passerelle-3 animate-enter4" src={sfondo_Schermata_Passerelle3} />
          </div>
          <h1 className="title inter-normal-black-36px">{title}</h1>
        </div>
        <div className="flex-row-2">
          <div className="plancett-container">
            <img className="sfondo_schermata_plancette-1-1" src={sfondo_Schermata_Plancette1} />
          ...
          <img className="sfondo_schermata_plancette-2-1" src={sfondo_Schermata_Plancette2} />
        </div>
      </div>
    </div>
  );
