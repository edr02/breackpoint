      ...
      <div className="desktop-6 inter-normal-black-24px screen">
        <div className="overlap-group-3">
          <div className="flex-row-5">
            <img className="rsp-logo-1-3" src={rspLogo1} alt="alt" />
            <TextInput className={textInputProps.className} />
          </div>
          <img className="line-1-3" src={line1} alt="alt" />
        </div>
        <div className="sfondo_schermata_passerelle-container-3">
          <img className="sfondo_schermata_passerelle-1-3 animate-enter8" src={sfondo_Schermata_Passerelle1} alt="alt" />
          <img className="sfondo_schermata_passerelle-2-3 animate-enter9" src={sfondo_Schermata_Passerelle2} alt="alt" />
        </div>
        <div className="passerella-2">{passerella}</div>
        <div className="sfondo_schermata_plancette-container-1">
          <img className="sfondo_schermata_plancette-1-3" src={sfondo_Schermata_Plancette1} alt="alt" />
          <img className="sfondo_schermata_plancette-3-2" src={sfondo_Schermata_Plancette3} alt="alt" />
        </div>
