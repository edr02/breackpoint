        ...
        <div className="flex-col-2">
          <div className="overlap-group-4">
            <div className="flex-row-6">
              <img className="rsp-logo-1-4" src={rspLogo1} alt="alt" />
              <TextInput className={textInputProps.className} />
            </div>
            <img className="line-1-4" src={line1} alt="alt" />
          </div>
          <div className="sfondo_schermata_passerelle-container-4">
            <img className="sfondo_schermata_passerelle-1-4 animate-enter10" src={sfondo_Schermata_Passerelle1} alt="alt" />
            <img className="sfondo_schermata_passerelle-2-4 animate-enter11" src={sfondo_Schermata_Passerelle2} alt="alt" />
            <img className="sfondo_schermata_passerelle-3-2 animate-enter12" src={sfondo_Schermata_Passerelle3} alt="alt" />
          </div>
          <div className="passerella-3 inter-normal-black-24px">{passerella}</div>
        </div>
        <div className="flex-row-7">
          <div className="plancett-container-2">
            <img className="sfondo_schermata_plancette-1-4" src={sfondo_Schermata_Plancette1} alt="alt" />
            <div className="plancetta-4 inter-normal-black-24px">{plancetta}</div>
          </div>
          <img className="sfondo_schermata_plancette-3-3" src={sfondo_Schermata_Plancette3} alt="alt" />
          <img className="sfondo_schermata_plancette-2-3" src={sfondo_Schermata_Plancette2} alt="alt" />
        </div>
      </div>
    </div>
  );
